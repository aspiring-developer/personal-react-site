          ...
          <div className="collapse navbar-collapse w-100" id="navbarNav">
            <ul className="navbar-nav ml-auto">
              <li className="nav-item">
                <Link className="nav-link" to="index.html"><i className="fas fa-home text-info"></i> Home <span className="sr-only">(current)</span></Link>
              </li>
              ...
              <ul className="dropdown">
                ...
                <ul className="dropdown-menu" aria-labelledby="dropdownMenu2">
                  ...
                  <li className="dropdown-item" type="button"><Link className="nav-link text-info" to="/painting"><i className="fas fa-paint-brush"></i> Oil Painting <br /> & Chalkboard Art</Link></li>
               </ul>
              </ul>
